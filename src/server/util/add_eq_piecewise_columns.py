"""Add the piecewise-equalisation columns to an existing RotorHazard database.

Idempotent. Existing profiles get NULL, which the server reads as "no piecewise
correction", so behaviour is unchanged until a calibration is applied.

    python3 util/add_eq_piecewise_columns.py <path-to-database.db>
"""
import sqlite3
import sys
