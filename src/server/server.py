...
def on_stage_race(*args):
    # Calibration rewrites coefficients and thresholds on the nodes and clears
    #  their peak tracking; starting a race in the middle of that would time
    #  it against an axis that is still moving.
